...
static const char DASHBOARD_HTML[] =
    ...
    ".stat-label{color:#a9bad1;font-size:clamp(8px,1.05vh,10px);margin-bottom:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n"
    ".stat-value{font-weight:800;font-size:clamp(9px,1.3vh,12px);line-height:1.15;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n"
