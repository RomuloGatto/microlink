...
static const char DASHBOARD_HTML[] =
    ...
    ".app{width:100vw;height:100dvh;padding:var(--pad);display:grid;grid-template-rows:auto minmax(0,1fr);gap:var(--gap);overflow:hidden}\n"
    ...
    ".btn-secondary{background:#10233a;border:1px solid #315273;color:#9cc7ff}\n"
    ...
    ".workspace{min-width:0;min-height:0;display:grid;grid-template-columns:clamp(150px,14vw,185px) minmax(0,1fr);gap:var(--gap)}\n"
    ".stats,.panel{background:linear-gradient(180deg,#102036cc,#0a1727ee);border:1px solid var(--line);box-shadow:var(--shadow)}\n"
    ".stats{min-width:0;min-height:0;border-radius:15px;padding:6px;display:flex;flex-direction:column;overflow:auto;scrollbar-width:thin;scrollbar-color:#294765 transparent}\n"
    ".stat{min-width:0;min-height:0;padding:clamp(7px,1vh,10px) 7px;display:flex;gap:7px;align-items:center;flex:1}\n"
    ".stat:not(:last-child){border-bottom:1px solid #1d324a}\n"
    ".stat-icon,.panel-icon{color:#6ca9ff;flex:0 0 auto}.stat-icon{width:clamp(18px,2.5vh,22px);height:clamp(18px,2.5vh,22px);display:grid;place-items:center}.stat-icon svg{width:100%;height:100%}\n"
    ...
    ".panels{height:100%;display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);grid-template-rows:minmax(0,1fr) minmax(0,1fr);gap:var(--gap);min-width:0;min-height:0}\n"
    ".panel:nth-child(1){grid-column:1;grid-row:1}.panel:nth-child(2){grid-column:2;grid-row:1}.panel:nth-child(3){grid-column:1;grid-row:2}.panel:nth-child(4){grid-column:2;grid-row:2}\n"
    ...
    "<button id='ota' class='btn btn-secondary' type='button'>Atualizar firmware</button>\n"
    "<input id='ota_file' type='file' accept='.bin,application/octet-stream' hidden>\n"
    ...
    "<div class='workspace'>\n"
    "<aside class='stats' aria-label='Indicadores de status'>\n"
    ...
    "<div id='countdown' class='countdown'><div class='count-num'><span id='count_value'>20</span><span id='count_suffix'>s</span></div><div id='count_label' class='count-label'>religando a fonte em...</div><div class='progress'><div id='progress'></div></div></div>\n"
