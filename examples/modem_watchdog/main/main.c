...
static const char DASHBOARD_HTML[] =
    ...
    "@media(min-width:861px){.app{width:min(1500px,calc(100% - 26px));margin:16px auto 20px}.hero{margin-bottom:12px;gap:16px}.brand{gap:13px}.brandmark{width:47px;height:47px}.brandmark svg{width:45px;height:45px}.hero h1{font-size:27px}.hero p{font-size:14px;margin-top:4px}.badge{padding:10px 15px;font-size:12px}.badge svg{width:18px;height:18px}.notice{margin:-2px 0 10px;padding:9px 12px;font-size:12px}.stats{gap:10px;margin-bottom:12px}.stat{min-height:76px;padding:11px 12px;gap:10px;border-radius:13px}.stat-icon{width:32px;height:32px}.stat-icon svg{width:25px;height:25px}.stat-label{font-size:12px;margin-bottom:3px}.stat-value{font-size:15px}.dot{width:9px;height:9px;margin-right:7px}.layout{gap:12px;margin-bottom:12px}.stack{gap:12px}.panel{padding:16px 17px;border-radius:15px}.panel-head{gap:10px;margin-bottom:11px}.panel-icon{width:29px;height:29px}.panel-icon svg{width:26px;height:26px}.panel h2{font-size:17px;margin-bottom:3px}.panel-sub{font-size:12px}.fields{gap:11px 12px}.field label{font-size:12px;margin-bottom:5px}.hint{font-size:11px;margin-top:4px;line-height:1.3}.input{height:40px;border-radius:9px;padding:0 12px;font-size:14px}.input.has-eye{padding-right:42px}.eye{right:4px;top:4px;width:32px;height:32px}.eye svg{width:17px;height:17px}.switch-row{gap:14px;margin-bottom:11px}.switch-title{font-size:13px}.switch-desc{font-size:11px;margin-top:2px}.switch{width:50px;height:27px;flex-basis:50px}.switch span:after{width:20px;height:20px;left:3px;top:2px}.switch input:checked+span:after{transform:translateX(23px)}.watch-grid{gap:10px}.footer{gap:16px;margin-top:11px}.health-link{font-size:13px}.actions{grid-template-columns:minmax(225px,310px) minmax(225px,310px);gap:12px}.btn{height:44px;border-radius:10px;font-size:14px}.footer-note{font-size:10px;margin-top:5px}.toast{right:16px;bottom:16px}.modal{padding:19px}.modal-actions{margin-top:18px}}\n"
    "@media(min-width:861px) and (max-height:700px){.app{margin:9px auto 11px}.hero{margin-bottom:8px}.brandmark{width:40px;height:40px}.brandmark svg{width:38px;height:38px}.hero h1{font-size:23px}.hero p{font-size:12px}.stats{margin-bottom:8px;gap:8px}.stat{min-height:64px;padding:8px 10px}.stat-icon{width:27px;height:27px}.stat-icon svg{width:22px;height:22px}.stat-label{font-size:10px}.stat-value{font-size:13px}.layout{gap:9px;margin-bottom:9px}.stack{gap:9px}.panel{padding:11px 13px}.panel-head{margin-bottom:7px}.panel h2{font-size:15px}.panel-sub{font-size:10px}.fields{gap:8px 9px}.field label{font-size:10px;margin-bottom:3px}.hint{font-size:9px;margin-top:2px}.input{height:34px;font-size:12px}.switch-row{margin-bottom:7px}.switch-desc{display:none}.watch-grid{gap:8px}.footer{margin-top:8px}.btn{height:39px}}\n"
    "@media(max-width:1100px){.stats{grid-template-columns:repeat(4,1fr)}.watch-grid{grid-template-columns:repeat(3,1fr)}}@media(max-width:860px){.layout{grid-template-columns:1fr}.actions{grid-template-columns:1fr 1fr}.footer{grid-template-columns:1fr}.footer-note{text-align:left}}@media(max-width:640px){.app{width:calc(100% - 20px);margin-top:15px}.hero{align-items:center}.hero h1{font-size:23px}.hero p{font-size:13px}.brandmark{width:44px;height:44px}.brandmark svg{width:42px;height:42px}.badge{padding:10px 12px;font-size:12px}.stats{grid-template-columns:1fr 1fr}.fields,.watch-grid{grid-template-columns:1fr}.field.full{grid-column:auto}.panel{padding:17px}.actions{grid-template-columns:1fr}.footer-note{text-align:center}}@media(max-width:420px){.stats{grid-template-columns:1fr}.hero{align-items:flex-start}.badge{position:absolute;right:10px;top:12px}}\n"
    "</style>\n"
    "</head>\n"
    "<body>\n"
